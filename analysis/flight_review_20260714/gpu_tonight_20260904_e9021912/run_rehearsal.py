...
try:
 ...
 for app in ['_09_M5_Fable_MotionISR_Rev3.py','_12_M5_NightVision_Max_Rev3.py','_11_M5_Fable_SuperRes_Rev4.py','_10_M5_Fable_ImageScout_Rev3.py']:
  ...
  cmd=[py,str(base/'gui_rehearsal.py'),app,*args,'-ApplePersistenceIgnoreState','YES'];st=time.time()
  p=subprocess.Popen(cmd,env=env,stdout=(out/(app+'.log')).open('w'),stderr=subprocess.STDOUT);children.append(p)
  try:code=p.wait(timeout=85)
